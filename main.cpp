...
int main()
{
    ...
    switch (choice)
    {
        ...
        if(Qburger - Sburger >= quant)
        {
            ...
            cout<<"\n\n\t\t "<<quant<<"  burger have been ordered to you!";
        ...
        if(Qnoodles - Snoodles >= quant)
        {
            ...
            cout<<"\n\n\t\t "<<quant<<"noodles have been ordered to you!";
        ...
        case 5:
        cout<<"\n\n Enter the shakes Quantity  you want:";
        ...
        if(Qshake - Sshake >= quant)
        {
            ...
            cout<<"\n\n\t\t "<<quant<<"shake have been ordered to you!";
        ...
        if(Qchicken - Schicken >= quant)
        {
            ...
            cout<<"\n\n\t\t "<<quant<<"chicken have been ordered to you!";
        ...
        case 7:
            ...
            cout<<"\n\n\n Total collection for the day:"<<Total_rooms+Total_pasta+Total_burger+Total_shake+Total_chicken+Total_noodles;
            break;
